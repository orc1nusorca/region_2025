"""
Django settings for space_api project.
...
SECRET_KEY = 'django-insecure-bkqyn_023q+zh=bx=#q!rz$k&ld&plw&ko77mq9o1@2t-bob%s'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'space_api_db',  # Имя вашей базы данных
